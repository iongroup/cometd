...
`jakarta.servlet.*` | End-Of-Community-Support (see https://github.com/cometd/cometd/issues/1179[#1179])

| CometD 6.0.x | Java 11 | Jetty 10.0.x | JakartaEE 8 +
JavaEE 8 +
`javax.servlet.*` | End-Of-Community-Support (see https://github.com/cometd/cometd/issues/1179[#1179])
