...
| CometD 9.0.x | Java 17 | Jetty 12.1.x | JakartaEE 11 | Stable
| CometD 8.0.x | Java 17 | Jetty 12.0.x | JakartaEE 10 | Stable
| CometD 7.0.x | Java 11 | Jetty 11.0.x | JakartaEE 9 +
`jakarta.servlet.*` | End-Of-Community-Support (see https://github.com/cometd/cometd/issues/1754[#1754])
| CometD 6.0.x | Java 11 | Jetty 10.0.x | JakartaEE 8 +
JavaEE 8 +
`javax.servlet.*` | End-Of-Community-Support (see https://github.com/cometd/cometd/issues/1754[#1754])
